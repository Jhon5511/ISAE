...
class GnrlRDetailsCnDatabase {

  static final _databaseName = "GnrlRDetailsCnDb.db";
  static final _databaseVersion = 1;
  static final table = 'gnrlRDetailsCn_table';

  GnrlRDetailsCnDatabase._privateConstructor();
  static final GnrlRDetailsCnDatabase instance = GnrlRDetailsCnDatabase._privateConstructor();
