...
class GnrlRSaldosCnDatabase {

  static final _databaseName = "GnrlRSaldosCnDb.db";
  static final _databaseVersion = 1;
  static final table = 'gnrlRSaldosCn_table';

  GnrlRSaldosCnDatabase._privateConstructor();
  static final GnrlRSaldosCnDatabase instance = GnrlRSaldosCnDatabase._privateConstructor();
