...
class GnrlRDetailsVivDatabase {

  static final _databaseName = "GnrlRDetailsVivDb.db";
  static final _databaseVersion = 1;
  static final table = 'gnrlRDetailsViv_table';

  GnrlRDetailsVivDatabase._privateConstructor();
  static final GnrlRDetailsVivDatabase instance = GnrlRDetailsVivDatabase._privateConstructor();
