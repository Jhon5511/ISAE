...
class GnrlRSaldosCmDatabase {

  static final _databaseName = "GnrlRSaldosCmDb.db";
  static final _databaseVersion = 1;
  static final table = 'gnrlRSaldosCm_table';

  GnrlRSaldosCmDatabase._privateConstructor();
  static final GnrlRSaldosCmDatabase instance = GnrlRSaldosCmDatabase._privateConstructor();
