...
class GnrlRDetailsDatabase {

  static final _databaseName = "GnrlRDetailsDb.db";
  static final _databaseVersion = 1;
  static final table = 'gnrlRDetails_table';

  GnrlRDetailsDatabase._privateConstructor();
  static final GnrlRDetailsDatabase instance = GnrlRDetailsDatabase._privateConstructor();
