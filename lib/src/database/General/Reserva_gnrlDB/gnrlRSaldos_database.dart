...
class GnrlRSaldosDatabase {

  static final _databaseName = "GnrlRSaldosDb.db";
  static final _databaseVersion = 1;
  static final table = 'gnrlRSaldos_table';

  GnrlRSaldosDatabase._privateConstructor();
  static final GnrlRSaldosDatabase instance = GnrlRSaldosDatabase._privateConstructor();
