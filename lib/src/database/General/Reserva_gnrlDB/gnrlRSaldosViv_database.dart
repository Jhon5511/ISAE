...
class GnrlRSaldosVivDatabase {

  static final _databaseName = "GnrlRSaldosVivDb.db";
  static final _databaseVersion = 1;
  static final table = 'gnrlRSaldosViv_table';

  GnrlRSaldosVivDatabase._privateConstructor();
  static final GnrlRSaldosVivDatabase instance = GnrlRSaldosVivDatabase._privateConstructor();
