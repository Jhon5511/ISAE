...
class GnrlRDetailsCmDatabase {

  static final _databaseName = "GnrlRDetailsCmDb.db";
  static final _databaseVersion = 1;
  static final table = 'gnrlRDetailsCm_table';

  GnrlRDetailsCmDatabase._privateConstructor();
  static final GnrlRDetailsCmDatabase instance = GnrlRDetailsCmDatabase._privateConstructor();
