...
class GnrlEDetailsCnDatabase {

  static final _databaseName = "GnrlEDetailsCnDb.db";
  static final _databaseVersion = 1;
  static final table = 'gnrlEDetailsCn_table';

  GnrlEDetailsCnDatabase._privateConstructor();
  static final GnrlEDetailsCnDatabase instance = GnrlEDetailsCnDatabase._privateConstructor();
