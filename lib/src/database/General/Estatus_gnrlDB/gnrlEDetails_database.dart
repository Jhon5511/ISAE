...
class GnrlEDetailsDatabase {

  static final _databaseName = "GnrlEDetailsDb.db";
  static final _databaseVersion = 1;
  static final table = 'gnrlEDetails_table';

  GnrlEDetailsDatabase._privateConstructor();
  static final GnrlEDetailsDatabase instance = GnrlEDetailsDatabase._privateConstructor();
