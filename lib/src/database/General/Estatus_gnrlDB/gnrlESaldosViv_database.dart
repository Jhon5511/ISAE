...
class GnrlESaldosVivDatabase {

  static final _databaseName = "GnrlESaldosVivDb.db";
  static final _databaseVersion = 1;
  static final table = 'gnrlESaldosViv_table';

  GnrlESaldosVivDatabase._privateConstructor();
  static final GnrlESaldosVivDatabase instance = GnrlESaldosVivDatabase._privateConstructor();
