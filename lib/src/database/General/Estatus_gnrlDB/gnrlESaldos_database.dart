...
class GnrlESaldosDatabase {

  static final _databaseName = "GnrlESaldosDb.db";
  static final _databaseVersion = 1;
  static final table = 'gnrlESaldos_table';

  GnrlESaldosDatabase._privateConstructor();
  static final GnrlESaldosDatabase instance = GnrlESaldosDatabase._privateConstructor();
