...
class GnrlESaldosCmDatabase {

  static final _databaseName = "GnrlESaldosCmDb.db";
  static final _databaseVersion = 1;
  static final table = 'gnrlESaldosCm_table';

  GnrlESaldosCmDatabase._privateConstructor();
  static final GnrlESaldosCmDatabase instance = GnrlESaldosCmDatabase._privateConstructor();
