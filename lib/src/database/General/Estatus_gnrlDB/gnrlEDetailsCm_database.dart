...
class GnrlEDetailsCmDatabase {

  static final _databaseName = "GnrlEDetailsCmDb.db";
  static final _databaseVersion = 1;
  static final table = 'gnrlEDetailsCm_table';

  GnrlEDetailsCmDatabase._privateConstructor();
  static final GnrlEDetailsCmDatabase instance = GnrlEDetailsCmDatabase._privateConstructor();
