...
class GnrlVSaldosVivDatabase {

  static final _databaseName = "GnrlVSaldosVivDb.db";
  static final _databaseVersion = 1;
  static final table = 'gnrlVSaldosViv_table';

  GnrlVSaldosVivDatabase._privateConstructor();
  static final GnrlVSaldosVivDatabase instance = GnrlVSaldosVivDatabase._privateConstructor();
