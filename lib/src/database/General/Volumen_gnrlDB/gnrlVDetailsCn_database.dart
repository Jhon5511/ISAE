...
class GnrlVDetailsCnDatabase {

  static final _databaseName = "GnrlVDetailsCnDb.db";
  static final _databaseVersion = 1;
  static final table = 'gnrlVDetailsCn_table';

  GnrlVDetailsCnDatabase._privateConstructor();
  static final GnrlVDetailsCnDatabase instance = GnrlVDetailsCnDatabase._privateConstructor();
