...
class GnrlVSaldosDatabase {

  static final _databaseName = "GnrlVSaldosDb.db";
  static final _databaseVersion = 1;
  static final table = 'gnrlVSaldos_table';

  GnrlVSaldosDatabase._privateConstructor();
  static final GnrlVSaldosDatabase instance = GnrlVSaldosDatabase._privateConstructor();
