...
class GnrlVSaldosCmDatabase {

  static final _databaseName = "GnrlVSaldosCmDb.db";
  static final _databaseVersion = 1;
  static final table = 'gnrlVSaldosCm_table';

  GnrlVSaldosCmDatabase._privateConstructor();
  static final GnrlVSaldosCmDatabase instance = GnrlVSaldosCmDatabase._privateConstructor();
