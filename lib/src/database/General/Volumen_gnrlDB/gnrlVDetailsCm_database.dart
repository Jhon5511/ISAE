...
class GnrlVDetailsCmDatabase {

  static final _databaseName = "GnrlVDetailsCmDb.db";
  static final _databaseVersion = 1;
  static final table = 'gnrlVDetailsCm_table';

  GnrlVDetailsCmDatabase._privateConstructor();
  static final GnrlVDetailsCmDatabase instance = GnrlVDetailsCmDatabase._privateConstructor();
