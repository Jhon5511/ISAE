...
class GnrlVDetailsDatabase {

  static final _databaseName = "GnrlVDetailsDb.db";
  static final _databaseVersion = 1;
  static final table = 'gnrlVDetails_table';

  GnrlVDetailsDatabase._privateConstructor();
  static final GnrlVDetailsDatabase instance = GnrlVDetailsDatabase._privateConstructor();
