...
class GnrlVSaldosCnDatabase {

  static final _databaseName = "GnrlVSaldosCnDb.db";
  static final _databaseVersion = 1;
  static final table = 'gnrlVSaldosCn_table';

  GnrlVSaldosCnDatabase._privateConstructor();
  static final GnrlVSaldosCnDatabase instance = GnrlVSaldosCnDatabase._privateConstructor();
