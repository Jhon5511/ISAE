...
class GnrlVDetailsVivDatabase {

  static final _databaseName = "GnrlVDetailsVivDb.db";
  static final _databaseVersion = 1;
  static final table = 'gnrlVDetailsViv_table';

  GnrlVDetailsVivDatabase._privateConstructor();
  static final GnrlVDetailsVivDatabase instance = GnrlVDetailsVivDatabase._privateConstructor();
