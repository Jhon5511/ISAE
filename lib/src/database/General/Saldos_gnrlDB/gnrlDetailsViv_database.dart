...
class GnrlDetailsVivDatabase {

  static final _databaseName = "GnrlDetailsVivDb.db";
  static final _databaseVersion = 1;
  static final table = 'gnrlDetailsViv_table';

  GnrlDetailsVivDatabase._privateConstructor();
  static final GnrlDetailsVivDatabase instance = GnrlDetailsVivDatabase._privateConstructor();
