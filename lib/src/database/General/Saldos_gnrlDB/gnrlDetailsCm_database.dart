...
class GnrlDetailsCmDatabase {

  static final _databaseName = "GnrlDetailsCmDb.db";
  static final _databaseVersion = 1;
  static final table = 'gnrlDetailsCm_table';

  GnrlDetailsCmDatabase._privateConstructor();
  static final GnrlDetailsCmDatabase instance = GnrlDetailsCmDatabase._privateConstructor();
