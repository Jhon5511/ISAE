...
class GnrlSaldosDatabase {

  static final _databaseName = "GnrlSaldosDb.db";
  static final _databaseVersion = 1;
  static final table = 'gnrlSaldos_table';

  GnrlSaldosDatabase._privateConstructor();
  static final GnrlSaldosDatabase instance = GnrlSaldosDatabase._privateConstructor();
