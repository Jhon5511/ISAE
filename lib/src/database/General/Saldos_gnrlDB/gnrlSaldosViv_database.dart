...
class GnrlSaldosVivDatabase {

  static final _databaseName = "GnrlSaldosVivDb.db";
  static final _databaseVersion = 1;
  static final table = 'gnrlSaldosViv_table';

  GnrlSaldosVivDatabase._privateConstructor();
  static final GnrlSaldosVivDatabase instance = GnrlSaldosVivDatabase._privateConstructor();
