...
class GnrlDetailsDatabase {

  static final _databaseName = "GnrlDetailsDb.db";
  static final _databaseVersion = 1;
  static final table = 'gnrlDetails_table';

  GnrlDetailsDatabase._privateConstructor();
  static final GnrlDetailsDatabase instance = GnrlDetailsDatabase._privateConstructor();
