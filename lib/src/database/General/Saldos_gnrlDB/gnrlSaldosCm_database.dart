...
class GnrlSaldosCmDatabase {

  static final _databaseName = "GnrlSaldosCmDb.db";
  static final _databaseVersion = 1;
  static final table = 'gnrlSaldosCm_table';

  GnrlSaldosCmDatabase._privateConstructor();
  static final GnrlSaldosCmDatabase instance = GnrlSaldosCmDatabase._privateConstructor();
