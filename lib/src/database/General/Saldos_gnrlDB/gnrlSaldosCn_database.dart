...
class GnrlSaldosCnDatabase {

  static final _databaseName = "GnrlSaldosCnDb.db";
  static final _databaseVersion = 1;
  static final table = 'gnrlSaldosCn_table';

  GnrlSaldosCnDatabase._privateConstructor();
  static final GnrlSaldosCnDatabase instance = GnrlSaldosCnDatabase._privateConstructor();
