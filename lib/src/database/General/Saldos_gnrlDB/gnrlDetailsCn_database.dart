...
class GnrlDetailsCnDatabase {

  static final _databaseName = "GnrlDetailsCnDb.db";
  static final _databaseVersion = 1;
  static final table = 'gnrlDetailsCn_table';

  GnrlDetailsCnDatabase._privateConstructor();
  static final GnrlDetailsCnDatabase instance = GnrlDetailsCnDatabase._privateConstructor();
